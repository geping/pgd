...
// Preload images
imageObj = new Image();
imgs = ["/images/gp/toggle.gif", "/images/gp/nyro/ajaxLoader.gif", "/images/gp/nyro/prev.gif", "/images/gp/nyro/next.gif"];
...
// MY_realityTotalValue()
Administry.MY_realityTotalValue = function (el, val, max) {
    var duration = 400;
    var span = $(el).find("span");
    var b = $(el).find("b");
    var w = Math.round((val / max) * 100);
    ...
    $(span).animate({
        ...
        $(el).attr("value", val);
        $(b).text(val+'MB').fadeIn('fast');
    });
}

// MY_realityUsedValue()
Administry.MY_realityUsedValue = function (el, val, max) {
    var duration = 400;
    var span = $(el).find("span");
    var b = $(el).find("b");
    var w = Math.round((val / max) * 100);
...
// MY_realityValue()
Administry.MY_realityFreeValue = function (el, val, max) {
    var duration = 400;
    var span = $(el).find("span");
    var b = $(el).find("b");
    var w = Math.round((val / max) * 100);
